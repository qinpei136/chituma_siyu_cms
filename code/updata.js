	...
	__DEFINE__(
		...
		function (require, module, exports) {
				...
				return (
					...
					(function (t, r) {
						...
						var n = [],
							...
							u = void 0;
						try {
							for (var a, i = t[Symbol.iterator](); !(o = (a = i.next()).done) && (n.push(a.value), !r || n.length !== r); o = !0);
						} catch (t) {
							(e = !0), (u = t);
						} finally {
							try {
			...
			var u = function t(r, n, u) {
				...
				a = Symbol("updata empty array item"),
				i = function t(n) {
					for (
						...
						var l = r(f[c], 2),
							y = l[0],
							b = l[1],
							m = "" === a ? y : a.endsWith("].") ? "".concat(a).concat(y) : "".concat(a, ".").concat(y);
				...
				c = function (t, r) {
					...
					return function (t) {
						return (
							(t.upData = function (t, n) {
								return r.debug && console.log("转化后效果:", i(t)), this.setData(i(t), n);
							}),
							n(t)
						);
					};
			...
			Object.defineProperty(exports, "objToPath", {
				enumerable: true,
				configurable: true,
				get: function () {
					return i;
			...
			Object.defineProperty(exports, "updataInit", {
				enumerable: true,
				configurable: true,
				get: function () {
					return c;
