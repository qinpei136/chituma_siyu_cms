      ...
      <el-container>
          ...
          >
            <el-card class="boxCard">
              ...
              <el-form-item label="订单名称:" size="mini">
                <el-input v-model="selectForm.name" size="mini"></el-input>
              </el-form-item>
              <el-form-item label="客户名称:" size="mini">
                <el-input v-model="selectForm.UsrName" size="mini"></el-input>
              </el-form-item>
            ...
            <el-card class="boxCard">
              ...
              <el-form-item label="性别:">
                <el-radio v-model="selectForm.gender" :label="1">男</el-radio>
                <el-radio v-model="selectForm.gender" :label="2">女</el-radio>
                <el-radio v-model="selectForm.gender" :label="0">不限</el-radio>
              </el-form-item>
              <br />
              <el-checkbox-group v-model="selectForm.ageList">
                <el-form-item label="年龄:">
                  ...
                  <el-checkbox
                    ...
                    >全选</el-checkbox
                  >
                  <el-radio v-model="selectForm.getAge" :label="1"
                    >不限</el-radio
                  >
                </el-form-item>
              </el-checkbox-group>
            ...
            <br />-->
              ...
              <el-form-item label="可选素材:" size="mini">
                <el-select
                  v-model="selectForm.material"
                  @change="setSelectShow"
                >
                  <el-option
        ...
        <el-footer>
          <el-row type="flex" justify="end">
            <el-button size="mini" @click="clearCenterDialog">取 消</el-button>
            <el-button
...
export default {
  ...
  mounted() {
    ...
    // console.log(this.$refs["set_drawe"]);
  },
  methods: {
    ...
    clearCenterDialog() {
      ...
      this.selectForm.UsrName = "";
      this.selectForm.material = "";
      this.selectForm.gender = 0;
      this.selectForm.price = "";
      this.selectForm.ageList = [];
      this.selectForm.timeList = [];
