          ...
          <el-form-item>
            <el-button
              ...
              @click="
                () => {
                  this.$router.push({
                    path: '/weapp/privateTrafficDetail',
                  });
                }
              "
              >定制套餐
        ...
        <el-form :model="mealForm" label-width="126px" label-position="left">
          ...
          <el-form-item label="投放详情">
            <div class="toDetail">
              <!-- <ul>
                  <li>
                    <div class="toDetailitem">播放时长(系统默认)</div>
                    <div class="toDetailitem">15秒</div>
                  </li>
                  <li>
                    <div class="toDetailitem">播放周期(系统默认)</div>
                    <div class="toDetailitem">120秒/次</div>
                  </li>
                  <li>
                    <div class="toDetailitem">每日播放(系统默认)</div>
                    <div class="toDetailitem">720次</div>
                  </li>
                  <li>
                    <div class="toDetailitem">屏幕类型(系统默认)</div>
                    <div class="toDetailitem">社区智媒屏</div>
                  </li>
                  <li>
                    <div class="toDetailitem">播放地点(系统默认)</div>
                    <div class="toDetailitem">小区单元门禁</div>
                  </li>
                </ul> -->
              <el-table
...
export default {
  ...
  methods: {
    ...
    allow_toLimits(row, postIsVerify) {
      // console.log(postIsVerify, row); //每项的数据
      ...
      // KindEditor.ready(function (K) {
      //   this.editorM = K.create("#editor_id", {
      //     filterMode: true,
      //     langType: "en",
      //     // readonlyMode: true,
      //   });
      // });
      // this.editorM.readonly(true);
