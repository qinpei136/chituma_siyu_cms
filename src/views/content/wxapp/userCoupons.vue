<template>
  <div class="table-container">
      ...
      <byui-query-form-left-panel>
        <el-form ref="form" :inline="true" @submit.native.prevent>
          ...
          <el-form-item label="状态">
            <el-select v-model="toSend.state" placeholder="投放状态" clearable>
              <el-option
    ...
    >
      ...
      <el-table-column prop="nickName" label="领取人微信昵称"></el-table-column>
      ...
      <el-table-column prop="type" label="优惠券类型">
        <template slot-scope="scope">
          <el-tag type="danger">
            {{ useFor[scope.row.type] }}
          </el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="reduce" label="满减金额(折扣)">
        <template slot-scope="scope">
          {{
            scope.row.type == 1
              ? `${scope.row.reduce}折`
      ...
      <el-table-column prop="gainWay" label="获取方式">
        <template slot-scope="scope">
          {{ getWay[scope.row.gainWay] }}
        </template>
      </el-table-column>
      ...
      <el-table-column label="状态">
        <template slot-scope="scope">
          <el-tag>
            {{ activeList_Status[scope.row.state] }}
          </el-tag>
        </template>
      </el-table-column>
    </el-table>
