...
const name = title || "赤兔马";
var tg = 1; //1测试2线上3--5000
var pathTo = {
  1: "https://test.ctmaidsp.com/", // 测试
  2: "https://ad.ctmaidsp.com", // 线上
  3: "http://116.62.181.223:5000", // 5000接口
};
module.exports = {
  publicPath,
  assetsDir,
  ...
  devServer: {
    ...
    proxy: {
      "/chtm": {
        target: pathTo[tg], //  测试
        // target: "https://ad.ctmaidsp.com", //  线上
        // target: "http://116.62.181.223:5000", // 测试
        // target: "http://ctmad.unwulian.com/", //  online
      ...
      "/sy": {
        target: pathTo[tg],
        // target: "https://test.ctmaidsp.com/", // 测试
        // target: "https://ad.ctmaidsp.com", // 线上
        // target: "http://116.62.181.223:5000", // 测试
      ...
      "/imock": {
        // target: 'http://madmin.lifeweek.com.cn', // 线上
